    ...
    <StyledStack>
      ...
      <StyledAboutMe>
        <Typography variant="body1" color="text.secondary" textAlign="justify" lineHeight="30px">
          ...
          <br />
          Boring, repetitive tasks which makes people miserable, automating them
          with software makes me happy. Machine should do the work so that
          people have time to think.
          <br />
          Each project is a conquest of its own. What seemed impossible before,
          then working hard toward it and seeing it work is the most satisfying
          experience about working on any project.
          <br />
